...
<head>
<meta charset="UTF-8">
<title>** kakaoMap02_주소를 좌표로 변환하여 위치와 설명 표시 **</title>
...
<body>
<h2>** Map Test02 : 주소를 좌표로 변환하여 위치와 설명 표시 **</h2>
<br><hr>
...
var addrs = [
		{ content:'성남1',  // 마커 롤오버시 표시할 내용
		  addr:'경기 성남시 분당구 구미동 7-2 (돌마로 46) 5층' },
		{ content:'성남2',   
		  addr:'경기 성남시 분당구 금곡동 167 (돌마로 47) 이코노샤르망 4층' },  
		{ content:'강남1',  
